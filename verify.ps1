...
$python = $null
foreach ($candidate in @((Join-Path $root ".venv\Scripts\python.exe"), (Get-Command "py" -ErrorAction SilentlyContinue).Source, (Get-Command "python" -ErrorAction SilentlyContinue).Source)) {
